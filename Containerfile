...
COPY dropshot-authorization-header ./dropshot-authorization-header
...
RUN curl -L --output-dir /tmp -O https://github.com/diesel-rs/diesel/releases/download/${DIESEL_VER}/diesel_cli-x86_64-unknown-linux-gnu.tar.xz \
    && curl -L --output-dir /tmp -O https://github.com/diesel-rs/diesel/releases/download/v2.3.5/diesel_cli-x86_64-unknown-linux-gnu.tar.xz.sha256 \
